...
Makine Çeviri, PC oyunlarını Türkçeye çeviren **ücretsiz ve açık** bir yerelleştirme altyapısıdır. Oyun dosyalarına dokunmadan, yapay zeka destekli çeviri modelleriyle çalışır.
...
Çeviri katkısı, hata bildirimi veya geliştirme önerileri için [Discord sunucumuza](https://discord.com/invite/QDezpy4QtV) katılabilirsin.
